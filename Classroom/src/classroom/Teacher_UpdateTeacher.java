...
public class Teacher_UpdateTeacher implements ActionListener{
    JFrame f;
    ...
    Teacher_UpdateTeacher(String id){
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update teacher set age='"+t3.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"' where emp_id='"+t12.getText()+"'";
        ...
        if(ae.getSource()==b1){
            ...
            try{
                ...
                String q= "select * from multilogin where username = '"+t12.getText()+"'";
    ...
    public static void main(String[] arg){
        new Teacher_UpdateTeacher("10004407").f.setVisible(true);
    }
}