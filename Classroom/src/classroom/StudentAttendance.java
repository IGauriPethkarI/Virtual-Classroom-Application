...
public class StudentAttendance extends JFrame implements ActionListener{
    ...
    StudentAttendance(){
        ...
        String branch[] = {"Computer Science","Information Technology","Electronics","Electronics & Telecommunication"};
        ...
        add(new JLabel("Select Semester"));
        add(c3);
        ...
        try{
            ...
            ResultSet rs = c.s.executeQuery("select * from student where branch='"+c1.getSelectedItem()+"'");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            String qry = "insert into attendance_student values("+ id +",'"+dt+"','"+f+"','"+f+"')";
