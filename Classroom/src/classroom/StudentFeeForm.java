...
public class StudentFeeForm extends JFrame implements ActionListener{
    ...
    public static void main(String[] args) {
        new StudentFeeForm("20003905").setVisible(true);
    }


    public StudentFeeForm(String uid) {
	...
	c1.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
        ...
        try{
            conn c = new conn();
            ResultSet rs = c.s.executeQuery("select * from student where rollno= '"+uid+"'");
            while(rs.next()){
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Computer Science","Information Technology","Electronics","Electronics & Telecommunication" }));
	...
	t1.setModel(new DefaultComboBoxModel(
			new String[] { "86000", "46000","88000","44000" }));
