...
public class s_ExaminationDetails extends JFrame implements ActionListener{
   ...
   public s_ExaminationDetails(String uid) {
    ...
    public static void main(String[] args){
        new s_ExaminationDetails("20003905").setVisible(true);
    }
